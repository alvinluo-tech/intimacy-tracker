      ...
      <ChartShell title="最近 12 周频率趋势">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data.weeklyTrend12}>
            ...
            <Line type="monotone" dataKey="value" stroke="#7170ff" strokeWidth={2} dot={false} />
          </LineChart>
        </ResponsiveContainer>
      </ChartShell>
      ...
      <ChartShell title="时长分布">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data.durationDistribution}>
            ...
            />
            <Tooltip contentStyle={tooltipStyle} />
            <Bar dataKey="value" fill="#7170ff" radius={[6, 6, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </ChartShell>
      ...
      <ChartShell title="星期分布">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data.weekdayDistribution}>
            ...
            />
            <Tooltip contentStyle={tooltipStyle} />
            <Bar dataKey="value" fill="#828fff" radius={[6, 6, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </ChartShell>
    </div>
